...
public class StudentListJDKMain {
    public StudentListJDKMain() {
        List<Student> kolekcjaStudentów = new ArrayList<Student>();
        ...
        System.out.println("----------JDK only---------");
        printStudents(kolekcjaStudentów);
        kolekcjaStudentów.sort(Student::JDKCompareTo);
        System.out.println();
        printStudents(kolekcjaStudentów);
        System.out.println("--------------------------");
        System.out.println();
